...
def _make_objects():
    ...
    class MyDumper(uoft_core.yaml.Dumper):
        pass
    ...
    uoft_core.yaml.add_constructor("!tag1", construct1, Loader=MyLoader)
    uoft_core.yaml.add_representer(MyTestClass1, represent1, Dumper=MyDumper)

    class MyTestClass2(MyTestClass1, uoft_core.yaml.YAMLObject):
        uoft_core.yaml.loader = MyLoader
        uoft_core.yaml.dumper = MyDumper
        uoft_core.yaml.tag = "!tag2"
    ...
    class YAMLobject1(uoft_core.yaml.YAMLObject):
        uoft_core.yaml.loader = MyLoader
        uoft_core.yaml.dumper = MyDumper
        uoft_core.yaml.tag = "!foo"
    ...
    class YAMLobject2(uoft_core.yaml.YAMLObject):
        uoft_core.yaml.loader = MyLoader
        uoft_core.yaml.dumper = MyDumper
        uoft_core.yaml.tag = "!bar"
