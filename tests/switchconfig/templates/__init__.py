...
get_template_data: a function which takes a template name, and an optional dictionary of variables 

The get_template_data function in this template module demonstrates two different ways of 
