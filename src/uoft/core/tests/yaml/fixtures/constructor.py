...
def _make_objects():
    ...
    class MyDumper(uoft.core.yaml.Dumper):
        pass
    ...
    uoft.core.yaml.add_constructor("!tag1", construct1, Loader=MyLoader)
    uoft.core.yaml.add_representer(MyTestClass1, represent1, Dumper=MyDumper)

    class MyTestClass2(MyTestClass1, uoft.core.yaml.YAMLObject):
        uoft.core.yaml.loader = MyLoader
        uoft.core.yaml.dumper = MyDumper
        uoft.core.yaml.tag = "!tag2"
    ...
    class YAMLobject1(uoft.core.yaml.YAMLObject):
        uoft.core.yaml.loader = MyLoader
        uoft.core.yaml.dumper = MyDumper
        uoft.core.yaml.tag = "!foo"
    ...
    class YAMLobject2(uoft.core.yaml.YAMLObject):
        uoft.core.yaml.loader = MyLoader
        uoft.core.yaml.dumper = MyDumper
        uoft.core.yaml.tag = "!bar"
...
try:
    from uoft.core.ordereddict import ordereddict
except ImportError:
