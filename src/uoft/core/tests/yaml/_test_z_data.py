...
from uoft.core.yaml.compat import _F

base_path = Path("data")  # that is uoft.core.yaml.data
...
class YAMLData(object):
    ...
    def from_yaml(cls, constructor, node):
        from uoft.core.yaml.nodes import MappingNode
...
class TestYAMLData(object):
    def yaml(self, yaml_version=None):
        from uoft.core.yaml import YAML
    ...
    def round_trip(self, input, output=None, yaml_version=None):
        from uoft.core.yaml.compat import StringIO
