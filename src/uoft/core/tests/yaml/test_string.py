...
from uoft.core.yaml.scalarstring import LiteralScalarString, DoubleQuotedScalarString
...
class TestWalkTree:
    def test_basic(self):
        from uoft.core.yaml.comments import CommentedMap
        from uoft.core.yaml.scalarstring import walk_tree
    ...
    def test_map(self):
        from uoft.core.yaml.compat import ordereddict
        from uoft.core.yaml.comments import CommentedMap
        from uoft.core.yaml.scalarstring import walk_tree, preserve_literal
        from uoft.core.yaml.scalarstring import DoubleQuotedScalarString as dq
        from uoft.core.yaml.scalarstring import SingleQuotedScalarString as sq
