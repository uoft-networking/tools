...
class MockFolders:
    ...
    def __init__(self, tmp_path: Path, app_name: str) -> None:
        self.root = tmp_path
        self.site_config = MockFolders.ConfDir(tmp_path / "etc/xdg/uoft-tools", app_name)
        # This would be:
        ...
        self.user_config = MockFolders.ConfDir(tmp_path / "home/user/.config/uoft-tools", app_name)
        # This would be:
        # - ~/Library/Application Support/uoft-tools on MacOS,
        ...
        self.user_config_env = MockFolders.ConfDir(tmp_path / "home/alternate", app_name)
