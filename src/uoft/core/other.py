...
additional dependencies not included in uoft.core by default.
"""
...
# deprecated, use `uoft.core.prompt.Prompt` instead
class Prompt:
    ...
    def path(  # pylint: disable=too-many-arguments
        ...
        **kwargs,
        ...
        opts = dict(
            completer=self.PathCompleter(only_directories=only_directories, **completer_opts),
            complete_while_typing=True,
        )
        opts.update(kwargs)
