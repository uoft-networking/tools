...
class RESTAPIError(HTTPError):
    ...
    def __str__(self) -> str:
        return f"{self.response.status_code}: {self.response.reason} - {self.data}"
...
class APIBase(Session):  # pyright: ignore[reportRedeclaration] # APIBase will be redeclared in a TYPE_CHECKING block below
    ...
    # an APIBase instance can still access these error types without having to import them from uoft.core.api
