...
class ScalarString(str):
    ...
    def __new__(
        cls: Union[
            ...
            Type[FoldedScalarString],
            Type[DoubleQuotedScalarString],
        ...
        **kw,
        ...
        FoldedScalarString, LiteralScalarString, DoubleQuotedScalarString, PlainScalarString, SingleQuotedScalarString
    ]:
