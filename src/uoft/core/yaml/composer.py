...
if TYPE_CHECKING:
    ...
    from uoft.core.yaml.events import MappingEndEvent, SequenceEndEvent
...
class Composer:
    ...
    def compose_node(
        self, parent: Optional[Union[MappingNode, SequenceNode]], index: Optional[Union[ScalarNode, SequenceNode, int]]
    ...
    def check_end_doc_comment(
        self, end_event: Union[SequenceEndEvent, MappingEndEvent], node: Union[MappingNode, SequenceNode]
    ) -> None:
