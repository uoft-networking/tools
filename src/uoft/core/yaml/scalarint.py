...
class ScalarInt(int):
    def __new__(
        cls: Union[Type[BinaryInt], Type[HexInt], Type[HexCapsInt], Type[ScalarInt], Type[OctalInt]], *args, **kw
    ) -> Union[ScalarInt, HexCapsInt, HexInt, OctalInt, BinaryInt]:
    ...
    def __ifloordiv__(
        self, a: Union[OctalInt, HexCapsInt, BinaryInt, HexInt]
    ) -> Union[OctalInt, HexCapsInt, BinaryInt, HexInt]:
        x = type(self)(self // a)
        x._width = self._width
        x._underscore = self._underscore[:] if self._underscore is not None else None  # NOQA
        return x
...
class BinaryInt(ScalarInt):
    def __new__(
        cls: Type[BinaryInt], value: int, width: None = None, underscore: None = None, anchor: None = None
    ) -> "BinaryInt":
...
class OctalInt(ScalarInt):
    def __new__(
        ...
        underscore: Optional[List[Union[int, bool]]] = None,
        anchor: None = None,
    ) -> "OctalInt":
        return ScalarInt.__new__(cls, value, width=width, underscore=underscore, anchor=anchor)
...
class HexCapsInt(ScalarInt):
    ...
    def __new__(
        cls: Type[HexCapsInt], value: int, width: None = None, underscore: None = None, anchor: None = None
    ) -> "HexCapsInt":
        return ScalarInt.__new__(cls, value, width=width, underscore=underscore, anchor=anchor)
