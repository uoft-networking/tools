...
if TYPE_CHECKING:
    ...
    from uoft.core.yaml.error import CommentMark, StringMark
...
class Token:
    ...
    def __init__(self, start_mark: Union[CommentMark, StringMark], end_mark: Optional[StringMark]) -> None:
    ...
    def add_post_comment(self, comment: "CommentToken") -> None:
    ...
    def comment(
        ...
        Union[
            List[Union[CommentToken, List[str]]],
            List[None],
            List[Optional[List[CommentToken]]],
            List[Optional[CommentToken]],
        ]
    ]:
        return getattr(self, "_comment", None)

    def move_old_comment(
        self, target: "Token", empty: bool = False
    ) -> Optional[Union[BlockEndToken, BlockEntryToken, ValueToken, KeyToken]]:
    ...
    def split_old_comment(self) -> Optional[List[Optional[CommentToken]]]:
...
class DirectiveToken(Token):
    ...
    def __init__(self, name: str, value: Tuple[int, int], start_mark: StringMark, end_mark: StringMark) -> None:
...
class StreamStartToken(Token):
    ...
    def __init__(
        self, start_mark: Optional[StringMark] = None, end_mark: Optional[StringMark] = None, encoding: None = None
    ) -> None:
        Token.__init__(self, start_mark, end_mark)
...
class AliasToken(Token):
    ...
    def __init__(self, value: str, start_mark: StringMark, end_mark: StringMark) -> None:
        Token.__init__(self, start_mark, end_mark)
        self.value = value
...
class TagToken(Token):
    ...
    def __init__(self, value: Tuple[str, str], start_mark: StringMark, end_mark: StringMark) -> None:
        Token.__init__(self, start_mark, end_mark)
        self.value = value
...
class ScalarToken(Token):
    ...
    def __init__(
        self, value: str, plain: bool, start_mark: StringMark, end_mark: StringMark, style: Optional[str] = None
    ) -> None:
        Token.__init__(self, start_mark, end_mark)
        self.value = value
        self.plain = plain
...
class CommentToken(Token):
    ...
    def __init__(
        self,
        value: str,
        start_mark: Optional[Union[CommentMark, StringMark]] = None,
