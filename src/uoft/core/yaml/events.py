...
class Event:
    ...
    def __repr__(self) -> str:
        if True:
            ...
            arguments = ", ".join([_F("{k!s}={attr!r}", k=key, attr=getattr(self, key)) for key in attributes])
            if self.comment not in [None, CommentCheck]:
...
class CollectionStartEvent(NodeEvent):
    ...
    def __init__(
        ...
        comment: Optional[
            Union[List[Optional[List[CommentToken]]], List[CommentToken], List[None], List[Optional[CommentToken]]]
        ] = None,
