...
from uoft.core.yaml.anchor import Anchor
...
from uoft.core.yaml.compat import ordereddict

if TYPE_CHECKING:
    from uoft.core.yaml.main import Dumper
from uoft.core.yaml.nodes import MappingNode, ScalarNode, SequenceNode
from uoft.core.yaml.scalarfloat import ScalarFloat
from uoft.core.yaml.scalarint import BinaryInt, HexInt, HexCapsInt, OctalInt, ScalarInt
...
class Representer:
    ...
    def represent_sequence(
        self, tag: str, sequence: Union[CommentedSeq, CommentedKeySeq], flow_style: Optional[bool] = None
    ) -> SequenceNode:
        value = []
    ...
    def represent_omap(
        self, tag: str, omap: Union[OrderedDict, CommentedOrderedMap], flow_style: None = None
    ) -> SequenceNode:
        value = []
        try:
    ...
    def represent_mapping(
        self, tag: str, mapping: Dict[str, int] | CommentedMap, flow_style: None = None
    ) -> MappingNode:
        value = []
        try:
    ...
    def insert_underscore(
        self, prefix: str, s: str, underscore: Optional[List[Union[int, bool]]], anchor: Optional[Anchor] = None
    ) -> ScalarNode:
    ...
    def merge_comments(
        ...
        comments: None | List[None] | List[CommentToken | List[CommentToken]],
