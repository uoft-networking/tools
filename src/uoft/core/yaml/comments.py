...
class CommentedBase:
    ...
    def yaml_key_comment_extend(
        self,
        key: Union[int, str],
        comment: List[Optional[Union[CommentToken, List[CommentToken]]]],
        clear: bool = False,
    ) -> None:
    ...
    def yaml_value_comment_extend(
        self, key: str, comment: List[Optional[Union[CommentToken, List[CommentToken], List[str]]]], clear: bool = False
    ) -> None:
        r = self.ca._items.setdefault(key, [None, None, None, None])
    ...
    def yaml_set_comment_before_after_key(
        ...
        after_indent: Optional[int] = None,
    ) -> None:
        """
    ...
    def yaml_add_eol_comment(
        self, comment: str, key: Union[int, str] = NoComment, column: Optional[int] = None
    ) -> None:
        """
...
class CommentedSeq(MutableSliceableSequence, list, CommentedBase):
    ...
    def _yaml_add_comment(
        self, comment: List[Optional[Union[CommentToken, List[CommentToken]]]], key: Union[Callable, int] = NoComment
    ) -> None:
...
class CommentedMap(ordereddict, CommentedBase):
    ...
    def _yaml_add_comment(
        self,
        comment: List[Optional[Union[CommentToken, List[CommentToken], List[str]]]],
        key: Union[Callable, str] = NoComment,
        value: Union[Callable, str] = NoComment,
    ) -> None:
