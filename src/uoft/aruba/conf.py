from uoft.core import BaseSettings, Field, root_validator
...
class Settings(BaseSettings):
    ...
    mm_vrrp_hostname: str = Field(title="Aruba Mobility Master Primary IP Adress / Hostname")
    md_hostnames: list[str] = Field(title="Aruba Controller (Managed Device) IP Adresses / Hostnames")
