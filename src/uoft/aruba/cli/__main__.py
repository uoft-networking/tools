...
from . import cpsec_allowlist, station_blocklist, list_aps
from uoft.aruba.conf import Settings
...
def _version_callback(value: bool):
    if not value:
        return
    assert __package__, "__package__ is None, cannot determine version"
