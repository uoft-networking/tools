...
class Client:
    ...
    def _require_minimal_version(self, version: Union[_Version, str]) -> None:
        ...
        if v and v < version:
            raise ClientError(
                f"The Address Manager version must be {version} or greater."
            )
    ...
    def add_entity(self, parent_id: int, entity: APIEntity) -> int:
        ...
        Example:
            ...
            .. code-block:: python
                ...
                from uoft_core._vendor.bluecat_libraries.address_manager.api import Client
                from uoft_core._vendor.bluecat_libraries.address_manager.api.models import APIEntity
    ...
    def get_ip_ranged_by_ip(
        ...
        self._require_auth()
        return APIEntity.from_raw_model(
            self.raw_api.getIPRangedByIP(container_id, type, address)
        )
    ...
    def get_zones_by_hint(
        ...
        Example:
            ...
            .. code-block:: python
                ...
                from uoft_core._vendor.bluecat_libraries.address_manager.api import Client
                from uoft_core._vendor.bluecat_libraries.address_manager.constants import AccessRightValues, ObjectType
    ...
    def add_resource_record(
        ...
        return self.raw_api.addResourceRecord(
            view_id, absolute_name, type, rdata, ttl, properties
        )
    ...
    def add_host_record(
        ...
        properties = serialize_joined_key_value_pairs(properties)
        return self.raw_api.addHostRecord(
            view_id, absolute_name, addresses, ttl, properties
        )
    ...
    def add_generic_record(
        ...
        self._require_auth()
        properties = serialize_joined_key_value_pairs(properties)
        return self.raw_api.addGenericRecord(
            view_id, absolute_name, type, rdata, ttl, properties
        )
    ...
    def add_hinfo_record(
        ...
        self._require_auth()
        properties = serialize_joined_key_value_pairs(properties)
        return self.raw_api.addHINFORecord(
            view_id, absolute_name, cpu, os, ttl, properties
        )
    ...
    def add_naptr_record(
        ...
        Example:
            ...
            .. code-block:: python
                ...
                from uoft_core._vendor.bluecat_libraries.address_manager.api import Client
                from uoft_core._vendor.bluecat_libraries.address_manager.constants import EnumServices
    ...
    def get_ip4_networks_by_hint(
        ...
        self._require_auth()
        options = serialize_joined_key_value_pairs(options)
        networks = self.raw_api.getIP4NetworksByHint(
            container_id, start, count, options
        )
    ...
    def unlink_entities(
        self, entity1_id: int, entity2_id: int, properties: dict = None
    ):
        """
    ...
    def add_enum_zone(
        self, entity_id: int, prefix: int, properties: Optional[dict] = None
    ) -> int:
        """
        Add an ENUM zone.
    ...
    def assign_or_update_template(
        self, zone_id: int, template_id: int, properties: dict
    ):
        """
    ...
    def reapply_template(self, id: int, properties: dict):
        ...
        Example:
            ...
            .. code-block:: python
                ...
                from uoft_core._vendor.bluecat_libraries.address_manager.api import Client
                from uoft_core._vendor.bluecat_libraries.address_manager.constants import ObjectType, ZoneTemplateReapplyMode
    ...
    def add_access_right(
        ...
        Example:
            ...
            .. code-block:: python
                ...
                from uoft_core._vendor.bluecat_libraries.address_manager.api import Client
                from uoft_core._vendor.bluecat_libraries.address_manager.constants import AccessRightValues
        ...
        properties = serialize_joined_key_value_pairs(properties)
        return self.raw_api.addAccessRight(
            entity_id, user_id, value, overrides, properties
        )
    ...
    def find_response_policies_with_item(
        ...
        self._require_auth()
        options = serialize_joined_key_value_pairs(options)
        policies = self.raw_api.findResponsePoliciesWithItem(
            configuration_id, item_name, options
        )
    ...
    def add_dns_deployment_role(
        ...
        Example:
            ...
            .. code-block:: python
                ...
                from uoft_core._vendor.bluecat_libraries.address_manager.api import Client
                from uoft_core._vendor.bluecat_libraries.address_manager.constants import DNSDeploymentRoleType
        ...
        self._require_auth()
        properties = serialize_joined_key_value_pairs(properties)
        return self.raw_api.addDNSDeploymentRole(
            entity_id, server_interface_id, type, properties
        )
    ...
    def get_dns_deployment_role(
        ...
        """
        self._require_auth()
        dns_deployment_role = self.raw_api.getDNSDeploymentRole(
            entity_id, server_interface_id
        )
    ...
    def update_dns_deployment_role(self, role: APIDeploymentRole):
        ...
        Example:
            ...
            .. code-block:: python
                ...
                from uoft_core._vendor.bluecat_libraries.address_manager.api import Client
                from uoft_core._vendor.bluecat_libraries.address_manager.constants import DNSDeploymentRoleType
                from uoft_core._vendor.bluecat_libraries.address_manager.api.models import APIDeploymentRole
    ...
    def delete_dns_deployment_role_for_view(
        ...
        """
        self._require_auth()
        self.raw_api.deleteDNSDeploymentRoleForView(
            entity_id, server_interface_id, view_id
        )
    ...
    def add_dhcp_deployment_role(
        ...
        Example:
            ...
            .. code-block:: python
                ...
                from uoft_core._vendor.bluecat_libraries.address_manager.api import Client
                from uoft_core._vendor.bluecat_libraries.address_manager.constants import DHCPDeploymentRoleType
        ...
        self._require_auth()
        properties = serialize_joined_key_value_pairs(properties)
        return self.raw_api.addDHCPDeploymentRole(
            entity_id, server_interface_id, type, properties
        )
    ...
    def get_dhcp_deployment_role(
        ...
        """
        self._require_auth()
        deployment_role = self.raw_api.getDHCPDeploymentRole(
            entity_id, server_interface_id
        )
    ...
    def add_dns_deployment_option(
        ...
        properties = serialize_joined_key_value_pairs(properties)
        return self.raw_api.addDNSDeploymentOption(
    ...
    def update_dns_deployment_option(self, option: APIDeploymentOption):
        ...
        Example:
            ...
            .. code-block:: python
                ...
                from uoft_core._vendor.bluecat_libraries.address_manager.api import Client
                from uoft_core._vendor.bluecat_libraries.address_manager.api.models import APIDeploymentOption
    ...
    def get_deployment_options(
        ...
        if option_types:
            option_types = (
                option_types[0] if len(option_types) == 1 else "|".join(option_types)
            )
        deployment_options = self.raw_api.getDeploymentOptions(
            entity_id, option_types, server_id
        )
    ...
    def get_dhcp6_service_deployment_option(
        ...
        self._require_auth()
        return APIDeploymentOption.from_raw_model(
            self.raw_api.getDHCP6ServiceDeploymentOption(
    ...
    def update_dhcp6_service_deployment_option(self, option: APIDeploymentOption):
        ...
        Example:
            ...
            .. code-block:: python
                ...
                from uoft_core._vendor.bluecat_libraries.address_manager.api import Client
                from uoft_core._vendor.bluecat_libraries.address_manager.constants import OptionType
                from uoft_core._vendor.bluecat_libraries.address_manager.api.models import APIDeploymentOption
        ...
        self._require_auth()
        self._require_minimal_version(_version.V9_1_0)
        self.raw_api.updateDHCP6ServiceDeploymentOption(
            APIDeploymentOption.to_raw_model(option)
        )
    ...
    def delete_dhcp6_service_deployment_option(
        ...
        """
        self._require_auth()
        self.raw_api.deleteDHCP6ServiceDeploymentOption(
            entity_id, option_name, server_id
        )
    ...
    def get_dhcp6_client_deployment_option(
        ...
        self._require_auth()
        return APIDeploymentOption.from_raw_model(
            self.raw_api.getDHCP6ClientDeploymentOption(
                entity_id, option_name, server_id
            )
        )
    ...
    def update_dhcp6_client_deployment_option(self, option: APIDeploymentOption):
        ...
        """
        self._require_auth()
        self.raw_api.updateDHCP6ClientDeploymentOption(
            APIDeploymentOption.to_raw_model(option)
        )
    ...
    def delete_dhcp6_client_deployment_option(
        ...
        Example:
            ...
            .. code-block:: python
                ...
                from uoft_core._vendor.bluecat_libraries.address_manager.constants import DHCP6ClientDeploymentOptionType
                from uoft_core._vendor.bluecat_libraries.address_manager.api import Client
        ...
        """
        self._require_auth()
        self.raw_api.deleteDHCP6ClientDeploymentOption(
            entity_id, option_name, server_id
        )
    ...
    def add_dhcp_client_deployment_option(
        ...
        value = serialize_possible_list(value)
        properties = serialize_joined_key_value_pairs(properties)
        return self.raw_api.addDHCPClientDeploymentOption(
            entity_id, option_name, value, properties
        )
    ...
    def update_dhcp_client_deployment_option(self, option: APIDeploymentOption):
        ...
        """
        self._require_auth()
        self.raw_api.updateDHCPClientDeploymentOption(
            APIDeploymentOption.to_raw_model(option)
        )
    ...
    def get_dhcp_service_deployment_option(
        ...
        Example:
            ...
            .. code-block:: python
                ...
                from uoft_core._vendor.bluecat_libraries.address_manager.api import Client
                from uoft_core._vendor.bluecat_libraries.address_manager.constants import DHCPServiceOption
    ...
    def update_dhcp_service_deployment_option(self, option: APIDeploymentOption):
        ...
        """
        self._require_auth()
        self.raw_api.updateDHCPServiceDeploymentOption(
            APIDeploymentOption.to_raw_model(option)
        )
    ...
    def delete_dhcp_service_deployment_option(
        ...
        """
        self._require_auth()
        self.raw_api.deleteDHCPServiceDeploymentOption(
            entity_id, option_name, server_id
        )
    ...
    def add_dhcp_vendor_deployment_option(
        ...
        value = serialize_possible_list(value)
        properties = serialize_joined_key_value_pairs(properties)
        return self.raw_api.addDHCPVendorDeploymentOption(
            entity_id, option_id, value, properties
        )
    ...
    def update_dhcp_vendor_deployment_option(self, option: APIDeploymentOption):
        ...
        """
        self._require_auth()
        self.raw_api.updateDHCPVendorDeploymentOption(
            APIDeploymentOption.to_raw_model(option)
        )
    ...
    def add_vendor_option_definition(
        ...
        Example:
            ...
            .. code-block:: python
                ...
                from uoft_core._vendor.bluecat_libraries.address_manager.api import Client
                from uoft_core._vendor.bluecat_libraries.address_manager.constants import VendorProfileOptionType
    ...
    def add_custom_option_definition(
        ...
        Example:
            ...
            .. code-block:: python
                ...
                from uoft_core._vendor.bluecat_libraries.address_manager.api import Client
                from uoft_core._vendor.bluecat_libraries.address_manager.constants import DHCPCustomOptionType
    ...
    def add_user_defined_field(self, object_type: str, udf: APIUserDefinedField):
        ...
        Example:
            ...
            .. code-block:: python
                ...
                from uoft_core._vendor.bluecat_libraries.address_manager.api import Client
                from uoft_core._vendor.bluecat_libraries.address_manager.api.models import APIUserDefinedField
                from uoft_core._vendor.bluecat_libraries.address_manager.constants import ObjectType, UserDefinedFieldType
        ...
        self._require_auth()
        self._require_minimal_version(_version.V9_1_0)
        self.raw_api.addUserDefinedField(
            object_type, APIUserDefinedField.to_raw_model(udf)
        )
    ...
    def get_linked_entities_ex(self, relationship: UDLRelationship) -> List[int]:
        ...
        self._require_auth()
        self._require_minimal_version(_version.V9_3_0)
        return self.raw_api.getLinkedEntitiesEx(
            UDLRelationship.to_raw_model(relationship)
        )
    ...
    def get_server_services_configuration_status(
    ...
    def configure_server_services(self, server_ids: list, configuration: dict) -> str:
        ...
        self._require_auth()
        self._require_minimal_version(_version.V9_3_0)
        token = self._raw_api.configureServerServices(
            ",".join(map(str, server_ids)), configuration
        )
        return token
    ...
    def get_linked_ip4_object_conflicts(self, template_id: int, entity_id: int) -> dict:
        ...
        self._require_minimal_version(_version.V9_3_0)
        return json.loads(
            self.raw_api.getLinkedIP4ObjectConflicts(template_id, entity_id)
        )
    ...
    def move_ip_object(
        self, entity_id: int, address: str, options: Optional[dict] = None
    ) -> None:
        """
    ...
    def resize_range(
        self, entity_id: int, range: str, options: Optional[dict] = None
    ) -> None:
        """
    ...
    def add_dhcp4_range(
        ...
        self._require_auth()
        properties = serialize_joined_key_value_pairs(properties)
        return self.raw_api.addDHCP4Range(
            network_id, start_address, end_address, properties
        )
    ...
    def add_dhcp4_range_by_size(
        ...
        Example:
            ...
            .. code-block:: python
                ...
                from uoft_core._vendor.bluecat_libraries.address_manager.api import Client
                from uoft_core._vendor.bluecat_libraries.address_manager.constants import DHCPDefineRange
    ...
    def add_dhcp6_range(
        ...
        self._require_auth()
        properties = serialize_joined_key_value_pairs(properties)
        return self.raw_api.addDHCP6Range(
            network_id, start_address, end_address, properties
        )
    ...
    def update_retention_settings(
        ...
        Example:
            ...
            .. code-block:: python
                ...
                from uoft_core._vendor.bluecat_libraries.address_manager.api import Client
                from uoft_core._vendor.bluecat_libraries.address_manager.api.models import RetentionSettings
    ...
    def add_response_policy(
        ...
        Example:
            ...
            .. code-block:: python
                ...
                from uoft_core._vendor.bluecat_libraries.address_manager.api import Client
                from uoft_core._vendor.bluecat_libraries.address_manager.constants import ResponsePolicy
        ...
        self._require_auth()
        properties = serialize_joined_key_value_pairs(properties)
        return self.raw_api.addResponsePolicy(
            configuration_id, name, type, ttl, properties
        )
    ...
    def associate_mac_address_with_pool(
        ...
        """
        self._require_auth()
        self.raw_api.associateMACAddressWithPool(
            configuration_id, mac_address, mac_pool_id
        )
    ...
    def assign_ip4_address(
        ...
        Example:
            ...
            .. code-block:: python
                ...
                from uoft_core._vendor.bluecat_libraries.address_manager.api import Client
                from uoft_core._vendor.bluecat_libraries.address_manager.constants import IPAssignmentActionValues
    ...
    def get_next_ip4_address(
        self, entity_id: int, properties: Optional[dict] = None
    ) -> str:
        """
    ...
    def is_address_allocated(
        ...
        """
        self._require_auth()
        return self.raw_api.isAddressAllocated(
            configuration_id, ip_address, mac_address
        )
    ...
    def add_ip4_ip_group_by_size(
        ...
        Example:
            ...
            .. code-block:: python
                ...
                from uoft_core._vendor.bluecat_libraries.address_manager.api import Client
                from uoft_core._vendor.bluecat_libraries.address_manager.constants import IPGroupRangePosition
    ...
    def get_next_available_ip_range(
        ...
        Example:
            ...
            .. code-block:: python
                ...
                from uoft_core._vendor.bluecat_libraries.address_manager.api import Client
                from uoft_core._vendor.bluecat_libraries.address_manager.constants import ObjectType, TraversalMethod
    ...
    def get_next_available_ip_ranges(
        ...
        return [
            APIEntity.from_raw_model(ip4_range) for ip4_range in available_ip4_ranges
        ]
    ...
    def get_ip6_objects_by_hint(
        ...
        self._require_auth()
        options = serialize_joined_key_value_pairs(options)
        ip6_objects = self.raw_api.getIP6ObjectsByHint(
            container_id, type, start, count, options
        )
    ...
    def get_next_available_ip6_address(
        ...
        properties = serialize_joined_key_value_pairs(properties)
        available_ip6_addresses = self.raw_api.getNextAvailableIP6Address(
    ...
    def clear_ip6_address(self, id: int):
        ...
        self._require_auth()
        response = self._raw_api.session.delete(
            self._raw_api._service.url
            + "/clearIP6Address",  # pylint: disable=protected-access
            params={"addressId": id},
            verify=self._raw_api.session.verify,
        )
        status = _wadl_parser.process_rest_response(response)
    ...
    def add_ip6_block_by_prefix(
        ...
        self._require_auth()
        properties = serialize_joined_key_value_pairs(properties)
        return self.raw_api.addIP6BlockByPrefix(
            parent_ip6_block_id, prefix, name, properties
        )
    ...
    def add_ip6_network_by_prefix(
        ...
        self._require_auth()
        properties = serialize_joined_key_value_pairs(properties)
        return self.raw_api.addIP6NetworkByPrefix(
            ip6_block_id, prefix, name, properties
        )

    def get_entity_by_prefix(
        self, container_id: int, prefix: str, type: str
    ) -> APIEntity:
        """
        ...
        self._require_auth()
        return APIEntity.from_raw_model(
            self.raw_api.getEntityByPrefix(container_id, prefix, type)
        )
    ...
    def add_server(
        ...
        Example:
            ...
            .. code-block:: python
                ...
                from uoft_core._vendor.bluecat_libraries.address_manager.api import Client
                from uoft_core._vendor.bluecat_libraries.address_manager.constants import ServerCapabilityProfiles
    ...
    def selective_deploy(
        self, entity_ids: list, properties: Optional[dict] = None
    ) -> str:
        """
    ...
    def get_additional_ip_addresses(
        ...
        Example:
            ...
            .. code-block:: python
                ...
                from uoft_core._vendor.bluecat_libraries.address_manager.constants import AdditionalIPServiceType
                from uoft_core._vendor.bluecat_libraries.address_manager.api import Client
    ...
    def add_dhcp_match_class(
        ...
        Example:
            ...
            .. code-block:: python
                ...
                from uoft_core._vendor.bluecat_libraries.address_manager.api import Client
                from uoft_core._vendor.bluecat_libraries.address_manager.constants import DHCPMatchClass
    ...
    def add_ip4_block_by_range(
        ...
        self._require_auth()
        properties = serialize_joined_key_value_pairs(properties)
        return self.raw_api.addIP4BlockByRange(
            entity_id, start_address, end_address, properties
        )
    ...
    def merge_selected_blocks_or_networks(
        ...
        """
        self._require_auth()
        self.raw_api.mergeSelectedBlocksOrNetworks(
            object_id_to_keep, object_ids_to_merge
        )
    ...
    def get_entity_by_cidr(self, parent_id: int, cidr: str, type: str) -> APIEntity:
        ...
        self._require_auth()
        return APIEntity.from_raw_model(
            self.raw_api.getEntityByCIDR(parent_id, cidr, type)
        )
    ...
    def add_ip4_reconciliation_policy(
        self, parent_id: int, name: str, properties: dict
    ) -> int:
        """
        ...
        Example:
            ...
            .. code-block:: python
                ...
                from uoft_core._vendor.bluecat_libraries.address_manager.api import Client
                from uoft_core._vendor.bluecat_libraries.address_manager.constants import DiscoveryType, SNMPVersion
    ...
    def establish_trust_relationship(
        ...
        self._require_auth()
        properties = serialize_joined_key_value_pairs(properties)
        self.raw_api.establishTrustRelationship(
            remote_ip, username, password, properties
        )

    def remove_trust_relationship(
        self, remote_ip: str, properties: Optional[dict] = None
    ) -> None:
        """
    ...
    def get_probe_status(self, defined_probe: str) -> int:
        ...
        Example:
            ...
            .. code-block:: python
                ...
                from uoft_core._vendor.bluecat_libraries.address_manager.api import Client
                from uoft_core._vendor.bluecat_libraries.address_manager.constants import DefinedProbe
    ...
    def start_probe(
        self, defined_probe: str, properties: Optional[dict] = None
    ) -> None:
        """
    ...
    def get_probe_data(
        ...
        self._require_auth()
        properties = serialize_joined_key_value_pairs(properties)
        return APIData.from_raw_model(
            self.raw_api.getProbeData(defined_probe, properties)
        )
    ...
    def break_xha_pair(
        self, xha_server_id: int, break_in_proteus_only: bool = False
    ) -> None:
        """
