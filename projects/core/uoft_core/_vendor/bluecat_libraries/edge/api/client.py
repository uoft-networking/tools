...
class EdgeClient(Client):
    ...
    def authenticate(
        self, client_id: str, client_secret: str, refresh_token: bool = False
    ):
        """
        ...
        Example:
            ...
            .. code:: python
                ...
                from uoft_core._vendor.bluecat_libraries.edge.api import EdgeClient
    ...
    def post_v1_api_customer_sitegroups_create(self, payload: dict) -> dict:
        ...
        self._require_auth()
        response = self.http_post(
            self._url_for("/v1/api/customer/siteGroups/create"), json=payload
        )
        return response.json()
    ...
    def post_v1_api_customer_sitegroups_delete(self, site_group_id: int):
        ...
        self.http_post(
            self._url_for(
                "/v1/api/customer/siteGroups/" + str(site_group_id) + "/delete"
            )
        )
    ...
    def post_v1_api_customer_sitegroups_update(self, site_group_id: int, payload: dict):
        ...
        self.http_post(
            self._url_for(
                "/v1/api/customer/siteGroups/" + str(site_group_id) + "/update"
            ),
            json=payload,
        )
    ...
    def patch_v2_domainlists(
        self,
        domain_list_id: str,
        domain_names_add: list = None,
        domain_names_remove: list = None,
    ):
        """
    ...
    def post_v1_api_list_dns_sourceconfiguration(
        self, domain_list_id: str, payload: dict
    ):
        """
        ...
        self._require_auth()
        self.http_post(
            self._url_for(f"/v1/api/list/dns/{domain_list_id}/sourceConfiguration"),
            json=payload,
        )
    ...
    def get_v1_api_list_dns_search(self, name_contains: str, desired_result_count: int):
        ...
        response = self.http_get(
            ...
            params=dict(
                nameContains=name_contains, desiredResultCount=desired_result_count
            ),
        )
        return response.json()
    ...
    def get_v5_api_policies(
        ...
        response = self.http_get(
            ...
            params=dict(
                siteId=site_id, siteGroupId=site_group_id, domainListId=domain_list_id
            ),
        )
        return response.json()
    ...
    def get_v1_api_namespaces(self, site_id: str = "") -> list:
        ...
        self._require_auth()
        response = self.http_get(
            self._url_for("/v1/api/namespaces"), params={"siteId": site_id}
        )
        return response.json()
    ...
    def get_v2_api_customer_dnsquerylog_count(self, site_name: str) -> dict:
        ...
        self._require_auth()
        response = self.http_get(
            self._url_for("/v2/api/customer/dnsQueryLog/count"),
            params=dict(siteName=site_name),
        )
        return response.json()
    ...
    def get_v1_api_list_system_content(self, list_name: str) -> str:
        ...
        self._require_auth()
        response = self.http_get(
            self._url_for("/v1/api/list/system/content/" + list_name)
        )
    ...
    def get_v1_api_list_system_information(self, list_name: str) -> dict:
        ...
        self._require_auth()
        response = self.http_get(
            self._url_for("/v1/api/list/system/information/" + list_name)
        )
        return response.json()
    ...
    def get_v2_api_spimage_config(self, site_id: str) -> str:
        ...
        self._require_auth()
        response = self.http_get(
            self._url_for("/v2/api/spImage/" + site_id + "/config")
        )
        return response.text
    ...
    def get_v2_api_spimage_status(self, site_id: str) -> dict:
        ...
        self._require_auth()
        response = self.http_get(
            self._url_for("/v2/api/spImage/" + site_id + "/status")
        )
        return response.json()
    ...
    def post_v1_api_list_dns_update(self, domain_list_id: str, payload: dict):
        ...
        self._require_auth()
        self.http_post(
            self._url_for("/v1/api/list/dns/" + domain_list_id + "/update"),
            json=payload,
        )
