...
importable_modules = [
    ...
    "uoft_nautobot.excel",
    "uoft_nautobot.diffsync",
    "uoft_nautobot.diffsync.bluecat",
    "uoft_nautobot.diffsync.bluecat.adapters",
    "uoft_nautobot.diffsync.bluecat.models",
    "uoft_nautobot.api",
    "uoft_nautobot.api.views",
    "uoft_nautobot.api.urls",
    "uoft_nautobot.management",
    "uoft_nautobot.management.commands.update_device_types",
    "uoft_nautobot.management.commands",
    "uoft_paloalto.cli",
    "uoft_paloalto",
    "uoft_paloalto.api",
    "uoft_bluecat.cli",
