...
class TestWalkTree:
    def test_basic(self):
        ...
        from uoft_core.yaml.scalarstring import walk_tree
    ...
    def test_map(self):
        from uoft_core.yaml.compat import ordereddict
        from uoft_core.yaml.comments import CommentedMap
        from uoft_core.yaml.scalarstring import walk_tree, preserve_literal
        from uoft_core.yaml.scalarstring import DoubleQuotedScalarString as dq
        from uoft_core.yaml.scalarstring import SingleQuotedScalarString as sq
