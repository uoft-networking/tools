...
def test_autocomplete_hostnames():
    all_hostanames = nautobot._autocomplete_hostnames("")
    access_switches = nautobot._autocomplete_hostnames("a1-")
...
def test_golden_config_templates():
    ...
    templates_dir = Path("~/uoft-tools/projects/nautobot/uoft_nautobot/tests/fixtures/_private/.gitlab_repo").expanduser()
    nautobot.push_changes_to_nautobot(templates_dir)
    nautobot.test_golden_config_templates('d1-ia', templates_dir)
