...
def load_local_jinja_library(_):
    ...
    # this is a bit of a hack, but it's the only way to dynamically
    # load filters from a git repo in nautobot golden config
...
BASE64_ENCODING_CHARS = "".join((string.ascii_uppercase, string.ascii_lowercase, string.digits, "+/"))
